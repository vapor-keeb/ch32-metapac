...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            BlockItem {
                name: "actlr",
                description: Some("Flash ACTL register."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "boot_modekeyp",
                description: Some("BOOT Mode select register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::Write,
                    bit_size: 32,
                    fieldset: Some("BootModekeyp"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fwakeie",
                    description: Some("Wakeup enable."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cfgrstt",
                    description: Some("Config reset delay time."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fwake_flag",
                    description: Some("FWAKE_FLAG mode start."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "turbo",
                    description: Some("TURBO mode start."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
