    ...
    blocks: &[
        Block {
            ...
            extends: None,
            description: Some(
                "Analog to digital converter of V103",
            ),
            items: &[
                BlockItem {
                    name: "statr",
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tkcps",
                    description: Some(
                        "Touch key counter period selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 26,
                ...
                Field {
                    name: "tkif",
                    description: Some(
                        "Touch key conversion finished flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 27,
        ...
        FieldSet {
            ...
            extends: None,
            description: Some(
                "Touch key status and data register",
            ),
            bit_size: 32,
            fields: &[
                Field {
                ...
                Field {
                    name: "tksta",
                    description: Some(
                        "Touch key working status, 1 for converting, 0 for pausing(TKDR can be read)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
    ...
    enums: &[
        ...
        Enum {
            name: "Tkcps",
            description: Some(
                "Touch key counting period selection",
            ),
            bit_size: 1,
            variants: &[
                EnumVariant {
