...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[Field {
                name: "latency",
                description: Some("FLASH standby condition."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fwakeie",
                    description: Some("wake-up interrupt enable."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cfgcanm",
                    description: Some("Configure the offline recovery time."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
