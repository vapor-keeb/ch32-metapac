...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "ctlr3",
                    description: Some("ADC control register 3."),
                    array: None,
                    byte_offset: 0x50,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "chgoffset",
                    description: Some("Charge time offset register (map of ADC_IDATAR1)"),
                    array: None,
                    byte_offset: 0x3c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "act_dcg",
                    description: Some("Activate and discharge time register (map of ADC_RDATAR)"),
                    array: None,
                    byte_offset: 0x4c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tkenable",
                    description: Some("Touch key module enable"),
                ...
                Field {
                    name: "tkitune",
                    description: Some("Touch key current tune"),
                ...
                Field {
                    name: "bufen",
                    description: Some("ADC BUFFER enable"),
                ...
                Field {
                    name: "pga",
                    description: Some("ADC channel gain configuration"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adc2data",
                    description: Some("Regular data of the second ADC, in dual mode"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 16,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        Enum {
            name: "Extsel",
            description: Some("External trigger event select for regular channels"),
            bit_size: 3,
            variants: &[
                EnumVariant {
                    name: "TIM1_CC1",
                ...
                EnumVariant {
                    name: "TIM4_CC4",
                    description: Some("Timer 4 capture compare 4"),
                    value: 5,
                },
                EnumVariant {
                    name: "TIM8_CC1_EXTI11",
                    description: Some("Timer 8 capture compare 1 and external interrupt line 11"),
                    value: 6,
                },
                EnumVariant {
                    name: "SWSTART",
        ...
        Enum {
            name: "Jextsel",
            description: Some("External trigger event select for injected channels"),
            bit_size: 3,
            variants: &[
                EnumVariant {
                    name: "TIM1_TRGO",
                ...
                EnumVariant {
                    name: "TIM3_CC4",
                    description: Some("Timer 3 capture compare 4"),
                    value: 4,
                },
                EnumVariant {
                    name: "TIM4_TRGO",
                ...
                EnumVariant {
                    ...
                    description: Some("Timer 8 capture compare 4 and external interrupt line 15"),
                    value: 6,
                },
                EnumVariant {
                    name: "JSWSTART",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "X16",
                    description: Some("x16"),
                    value: 2,
                },
                EnumVariant {
                    name: "X64",
                    description: Some("x64"),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "FULL",
                    description: Some("35uA"),
                    value: 0,
                },
                EnumVariant {
                    name: "HALF",
                    description: Some("Decrease to half"),
                    value: 1,
                },
            ],
        },
