...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "rdatar",
                description: Some("regular data register_start and discharge time register."),
                array: None,
                byte_offset: 0x4c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "adc_buftrim",
                    description: Some("ADC buffer misalignment control."),
                ...
                Field {
                    name: "fifo_en",
                    description: Some("ADC FIFO enable."),
                ...
                Field {
                    name: "adc_duty_en",
                    description: Some("ADC clock duty control."),
                ...
                Field {
                    name: "tkey_drv_en",
                    description: Some("TOUCHKEY shielded enable."),
                ...
                Field {
                    name: "tkey_drv_outen",
                    description: Some("TOUCHKEY shielded each channel enable."),
                ...
                Field {
                    name: "tkey_sel",
                    description: Some("TOUCHKEY bias current."),
                ...
                Field {
                    name: "tkey_wake_en",
                    description: Some("TOUCHKEY Wake-up enable."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cal_mod",
                    description: Some("ADC calibration mode control."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 21 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            name: "Samptr1",
            extends: None,
            description: Some("sample time register 1. Only ch 18, 17, 16 are available."),
            bit_size: 32,
            fields: &[Field {
                name: "smp",
    ...
    enums: &[
        ...
        Enum {
            name: "SampleTime",
            description: Some("Sample time selection, when ADC_LP=0"),
            bit_size: 3,
            variants: &[
                EnumVariant {
                    name: "CYCLES1_5",
