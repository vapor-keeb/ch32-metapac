    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "usbfsen",
                    description: Some("USBFSEN clock enable."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "usbfsrst",
                    description: Some("USBFD reset control."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "usbpdrst",
                    description: Some("USBPD reset control."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lptimen",
                    description: Some("LPTIM clock enable."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adc_duty_chg",
                    description: Some("ADC clock duty cycle control."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 28 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "adc_pre_adj",
                    description: Some("ADC clock input selection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "hsirdy",
                    description: Some("HSI Internal High Speed clock ready flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hsilp",
                    description: Some("HSI Internal low-power mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hselp",
                    description: Some("HSE low-power mode."),
