...
impl Usbd {
    ...
    #[inline(always)]
    pub const fn uep_dma(self, n: usize) -> crate::common::Reg<regs::UepDma, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x20usize + n * 4usize) as _) }
    }
    #[doc = "endpoint transmit length."]
    #[inline(always)]
    pub const fn uep_t_len(self, n: usize) -> crate::common::Reg<regs::UepTLen, crate::common::RW> {
        assert!(n < 8usize);
...
pub mod regs {
    ...
    impl UepCtrl {
        ...
        #[inline(always)]
        pub const fn mask_r_tog(&self) -> bool {
    ...
    impl UepDma {
        #[doc = "DMA buffer address of USB endpoint X."]
        #[inline(always)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct UepTLen(pub u32);
    impl UepTLen {
        #[doc = "transmit length of USB endpoint X. The length varies with the endpoint type."]
        #[inline(always)]
        ...
        #[doc = "USB host PID\\[3\\]"]
        #[inline(always)]
        pub const fn host_pid3(&self) -> bool {
            let val = (self.0 >> 7usize) & 0x01;
            val != 0
        }
        #[doc = "USB host PID\\[3\\]"]
        #[inline(always)]
        pub fn set_host_pid3(&mut self, val: bool) {
    ...
    impl UsbIntEn {
        ...
        #[doc = "USB one wire mode enable"]
        #[inline(always)]
        pub const fn one_wire(&self) -> bool {
            let val = (self.0 >> 5usize) & 0x01;
            val != 0
        }
        #[doc = "USB one wire mode enable"]
        #[inline(always)]
        pub fn set_one_wire(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u8) & 0x01) << 5usize);
        }
    ...
    impl UsbIntSt {
        ...
        #[doc = "RO, indicate setup packet received."]
        #[inline(always)]
        pub const fn setup_ack(&self) -> bool {
            let val = (self.0 >> 7usize) & 0x01;
            val != 0
        }
        #[doc = "RO, indicate setup packet received."]
        #[inline(always)]
        pub fn set_setup_ack(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u8) & 0x01) << 7usize);
        }
    }
