...
#[doc = "Systick registers, 64-bit downcounter for QingKeV4."]
...
impl Systick {
    ...
    #[doc = "System counter register, lower 32-bit."]
    #[inline(always)]
    pub const fn cntl(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x08usize) as _) }
    }
    #[doc = "System counter register, upper 32-bit."]
    #[inline(always)]
    ...
    #[doc = "System count compare register, lower 32-bit."]
    #[inline(always)]
    pub const fn cmpl(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x10usize) as _) }
    }
    #[doc = "System count compare register, upper 32-bit."]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Ctlr {
        ...
        #[doc = "Counter initial value update."]
        #[inline(always)]
