...
#[doc = "Analog to digital converter of V103"]
...
impl Tkey {
    ...
    #[doc = "TKEY_V control register"]
    #[inline(always)]
    pub const fn ctlr(self) -> crate::common::Reg<regs::TkCtlr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0cusize) as _) }
    }
    #[doc = "sample time register 1."]
    #[inline(always)]
    ...
    #[doc = "Touch key channel selection register"]
    #[inline(always)]
    pub const fn channel(self) -> crate::common::Reg<regs::TkChannel, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x34usize) as _) }
    }
    #[doc = "regular sequence register 3."]
    #[inline(always)]
    ...
    #[doc = "Status and data register"]
    #[inline(always)]
    pub const fn sdr(self) -> crate::common::Reg<regs::TkSdr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x4cusize) as _) }
    }
}
pub mod regs {
    ...
    impl Default for TkChannel {
        #[inline(always)]
        fn default() -> TkChannel {
            TkChannel(0)
        }
    }
    #[doc = "Touch key control register"]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct TkCtlr(pub u32);
    impl TkCtlr {
        #[doc = "Touch key module enable"]
        #[inline(always)]
        pub const fn tkenable(&self) -> bool {
        ...
        #[doc = "Touch key interrupt enable"]
        #[inline(always)]
        pub const fn tkien(&self) -> bool {
            let val = (self.0 >> 25usize) & 0x01;
            val != 0
        }
        #[doc = "Touch key interrupt enable"]
        #[inline(always)]
        pub fn set_tkien(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize);
        }
        #[doc = "Touch key counter period selection"]
        #[inline(always)]
        pub const fn tkcps(&self) -> super::vals::Tkcps {
            let val = (self.0 >> 26usize) & 0x01;
            super::vals::Tkcps::from_bits(val as u8)
        }
        #[doc = "Touch key counter period selection"]
        #[inline(always)]
        pub fn set_tkcps(&mut self, val: super::vals::Tkcps) {
            self.0 = (self.0 & !(0x01 << 26usize)) | (((val.to_bits() as u32) & 0x01) << 26usize);
        }
        #[doc = "Touch key conversion finished flag"]
        #[inline(always)]
        pub const fn tkif(&self) -> bool {
            let val = (self.0 >> 27usize) & 0x01;
            val != 0
        }
        #[doc = "Touch key conversion finished flag"]
        #[inline(always)]
        pub fn set_tkif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 27usize)) | (((val as u32) & 0x01) << 27usize);
        }
        #[doc = "Touch key counter time base"]
        #[inline(always)]
        pub const fn ccsel(&self) -> super::vals::Ccsel {
            let val = (self.0 >> 28usize) & 0x07;
            super::vals::Ccsel::from_bits(val as u8)
        }
        #[doc = "Touch key counter time base"]
        #[inline(always)]
        pub fn set_ccsel(&mut self, val: super::vals::Ccsel) {
            self.0 = (self.0 & !(0x07 << 28usize)) | (((val.to_bits() as u32) & 0x07) << 28usize);
        }
    }
    impl Default for TkCtlr {
        #[inline(always)]
        fn default() -> TkCtlr {
            TkCtlr(0)
        }
    }
    #[doc = "Touch key status and data register"]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct TkSdr(pub u32);
    impl TkSdr {
        #[doc = "Touch key data"]
        #[inline(always)]
        pub const fn tkdr(&self) -> u16 {
            let val = (self.0 >> 0usize) & 0x3fff;
            val as u16
        }
        #[doc = "Touch key data"]
        #[inline(always)]
        pub fn set_tkdr(&mut self, val: u16) {
            self.0 = (self.0 & !(0x3fff << 0usize)) | (((val as u32) & 0x3fff) << 0usize);
        }
        #[doc = "Touch key working status, 1 for converting, 0 for pausing(TKDR can be read)"]
        #[inline(always)]
        pub const fn tksta(&self) -> bool {
            let val = (self.0 >> 15usize) & 0x01;
            val != 0
        }
        #[doc = "Touch key working status, 1 for converting, 0 for pausing(TKDR can be read)"]
        #[inline(always)]
        pub fn set_tksta(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
    }
    impl Default for TkSdr {
        #[inline(always)]
        fn default() -> TkSdr {
            TkSdr(0)
        }
...
pub mod vals {
    ...
    #[doc = "Touch key counting period selection"]
    #[repr(u8)]
    #[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
    pub enum Tkcps {
        PERIOD_500US = 0x0,
    ...
    impl Tkcps {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Tkcps {
    ...
    impl From<u8> for Tkcps {
        #[inline(always)]
        fn from(val: u8) -> Tkcps {
            Tkcps::from_bits(val)
        }
    }
    impl From<Tkcps> for u8 {
        #[inline(always)]
        fn from(val: Tkcps) -> u8 {
            Tkcps::to_bits(val)
        }
    }
}
