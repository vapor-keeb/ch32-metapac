...
pub mod regs {
    ...
    impl Apb1pcenr {
        ...
        #[doc = "LPTIM clock enable."]
        #[inline(always)]
        pub fn set_lptimen(&mut self, val: bool) {
    ...
    impl Cfgr0 {
        ...
        #[doc = "ADC clock duty cycle control."]
        #[inline(always)]
        pub const fn adc_duty_chg(&self) -> u8 {
            let val = (self.0 >> 28usize) & 0x07;
            val as u8
        }
        #[doc = "ADC clock duty cycle control."]
        #[inline(always)]
        pub fn set_adc_duty_chg(&mut self, val: u8) {
            self.0 = (self.0 & !(0x07 << 28usize)) | (((val as u32) & 0x07) << 28usize);
        }
        #[doc = "ADC clock input selection."]
        #[inline(always)]
        pub const fn adc_pre_adj(&self) -> bool {
            let val = (self.0 >> 31usize) & 0x01;
            val != 0
        }
        #[doc = "ADC clock input selection."]
        #[inline(always)]
        pub fn set_adc_pre_adj(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl Ctlr {
        ...
        #[doc = "HSI Internal High Speed clock ready flag."]
        #[inline(always)]
        ...
        #[doc = "HSI Internal low-power mode."]
        #[inline(always)]
        pub const fn hsilp(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[doc = "HSI Internal low-power mode."]
        #[inline(always)]
        pub fn set_hsilp(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "HSE low-power mode."]
        #[inline(always)]
        pub const fn hselp(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[doc = "HSE low-power mode."]
        #[inline(always)]
        pub fn set_hselp(&mut self, val: bool) {
...
pub mod vals {
    ...
    #[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
    pub enum Pllsrc {
        #[doc = "HSI or HSI/2 selected as PLL input clock."]
        HSI = 0x0,
        #[doc = "HSE or HSE/2 selected as PLL input clock."]
        HSE = 0x01,
    }
    impl Pllsrc {
        #[inline(always)]
