...
# [inline (always)]
pub const fn ctlr2 (self) -> crate :: common :: Reg < regs :: Ctlr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x04usize) as _) } } # [doc = "Own address register 1."]
# [inline (always)]
pub const fn oaddr1 (self) -> crate :: common :: Reg < regs :: Oaddr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x08usize) as _) } } # [doc = "Own address register 2."]
# [inline (always)]
pub const fn oaddr2 (self) -> crate :: common :: Reg < regs :: Oaddr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0cusize) as _) } } # [doc = "Data register."]
# [inline (always)]
pub const fn datar (self) -> crate :: common :: Reg < regs :: Datar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x10usize) as _) } } # [doc = "Status register 1."]
# [inline (always)]
pub const fn star1 (self) -> crate :: common :: Reg < regs :: Star1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x14usize) as _) } } # [doc = "Status register 2."]
# [inline (always)]
pub const fn star2 (self) -> crate :: common :: Reg < regs :: Star2 , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x18usize) as _) } } # [doc = "Clock control register."]
# [inline (always)]
pub const fn ckcfgr (self) -> crate :: common :: Reg < regs :: Ckcfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1cusize) as _) } } # [doc = "Raise time register."]
# [inline (always)]
pub const fn rtr (self) -> crate :: common :: Reg < regs :: Rtr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } } pub mod regs { # [doc = "Clock control register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ckcfgr (pub u32) ; impl Ckcfgr { # [doc = "Clock control register in Fast/Standard mode (Master mode)."]
# [inline (always)]
...
# [inline (always)]
pub const fn duty (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "Fast mode duty cycle."]
# [inline (always)]
pub fn set_duty (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } # [doc = "I2C master mode selection."]
# [inline (always)]
pub const fn f_s (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "I2C master mode selection."]
# [inline (always)]
pub fn set_f_s (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Ckcfgr { # [inline (always)]
fn default () -> Ckcfgr { Ckcfgr (0) } } # [doc = "Control register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ctlr1 (pub u32) ; impl Ctlr1 { # [doc = "Peripheral enable."]
# [inline (always)]
...
# [inline (always)]
pub const fn pos (& self) -> bool { let val = (self . 0 >> 11usize) & 0x01 ; val != 0 } # [doc = "Acknowledge/PEC Position (for data reception)."]
# [inline (always)]
pub fn set_pos (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } # [doc = "Packet error checking."]
# [inline (always)]
...
# [inline (always)]
pub fn set_swrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Ctlr1 { # [inline (always)]
fn default () -> Ctlr1 { Ctlr1 (0) } } # [doc = "Control register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ctlr2 (pub u32) ; impl Ctlr2 { # [doc = "Peripheral clock frequency."]
# [inline (always)]
...
# [inline (always)]
pub fn set_last (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } } impl Default for Ctlr2 { # [inline (always)]
fn default () -> Ctlr2 { Ctlr2 (0) } } # [doc = "Data register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Datar (pub u32) ; impl Datar { # [doc = "8-bit data register."]
# [inline (always)]
pub const fn datar (& self) -> u8 { let val = (self . 0 >> 0usize) & 0xff ; val as u8 } # [doc = "8-bit data register."]
# [inline (always)]
pub fn set_datar (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 0usize)) | (((val as u32) & 0xff) << 0usize) ; } } impl Default for Datar { # [inline (always)]
fn default () -> Datar { Datar (0) } } # [doc = "Own address register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Oaddr1 (pub u32) ; impl Oaddr1 { # [doc = "Interface address."]
# [inline (always)]
pub const fn add0 (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Interface address."]
# [inline (always)]
pub fn set_add0 (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Interface address."]
# [inline (always)]
pub const fn add7_1 (& self) -> u8 { let val = (self . 0 >> 1usize) & 0x7f ; val as u8 } # [doc = "Interface address."]
# [inline (always)]
pub fn set_add7_1 (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x7f << 1usize)) | (((val as u32) & 0x7f) << 1usize) ; } # [doc = "Interface address."]
# [inline (always)]
pub const fn add9_8 (& self) -> u8 { let val = (self . 0 >> 8usize) & 0x03 ; val as u8 } # [doc = "Interface address."]
# [inline (always)]
pub fn set_add9_8 (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 8usize)) | (((val as u32) & 0x03) << 8usize) ; } # [doc = "Must be 1."]
# [inline (always)]
pub const fn must1 (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "Must be 1."]
# [inline (always)]
pub fn set_must1 (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } # [doc = "Addressing mode (slave mode)."]
# [inline (always)]
pub const fn addmode (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "Addressing mode (slave mode)."]
# [inline (always)]
pub fn set_addmode (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Oaddr1 { # [inline (always)]
fn default () -> Oaddr1 { Oaddr1 (0) } } # [doc = "Own address register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Oaddr2 (pub u32) ; impl Oaddr2 { # [doc = "Dual addressing mode enable."]
# [inline (always)]
pub const fn endual (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Dual addressing mode enable."]
# [inline (always)]
pub fn set_endual (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Interface address."]
# [inline (always)]
pub const fn add2 (& self) -> u8 { let val = (self . 0 >> 1usize) & 0x7f ; val as u8 } # [doc = "Interface address."]
# [inline (always)]
pub fn set_add2 (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x7f << 1usize)) | (((val as u32) & 0x7f) << 1usize) ; } } impl Default for Oaddr2 { # [inline (always)]
fn default () -> Oaddr2 { Oaddr2 (0) } } # [doc = "Raise time register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Rtr (pub u32) ; impl Rtr { # [doc = "Maximum rise time in Fast/Standard mode (Master mode)."]
# [inline (always)]
pub const fn trise (& self) -> u8 { let val = (self . 0 >> 0usize) & 0x3f ; val as u8 } # [doc = "Maximum rise time in Fast/Standard mode (Master mode)."]
# [inline (always)]
pub fn set_trise (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x3f << 0usize)) | (((val as u32) & 0x3f) << 0usize) ; } } impl Default for Rtr { # [inline (always)]
fn default () -> Rtr { Rtr (0) } } # [doc = "Status register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Star1 (pub u32) ; impl Star1 { # [doc = "Start bit (Master mode)."]
# [inline (always)]
pub const fn sb (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Start bit (Master mode)."]
# [inline (always)]
pub fn set_sb (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Address sent (master mode)/matched (slave mode)."]
# [inline (always)]
...
# [inline (always)]
pub const fn rx_ne (& self) -> bool { let val = (self . 0 >> 6usize) & 0x01 ; val != 0 } # [doc = "Data register not empty (receivers)."]
# [inline (always)]
pub fn set_rx_ne (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize) ; } # [doc = "Data register empty (transmitters)."]
# [inline (always)]
pub const fn tx_e (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Data register empty (transmitters)."]
# [inline (always)]
pub fn set_tx_e (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Bus error."]
# [inline (always)]
...
# [inline (always)]
pub fn set_smbalert (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Star1 { # [inline (always)]
fn default () -> Star1 { Star1 (0) } } # [doc = "Status register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Star2 (pub u32) ; impl Star2 { # [doc = "Master/slave."]
# [inline (always)]
...
# [inline (always)]
pub fn set_pec (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 8usize)) | (((val as u32) & 0xff) << 8usize) ; } } impl Default for Star2 { # [inline (always)]
fn default () -> Star2 { Star2 (0) } } }