...
# [inline (always)]
pub const fn dor (self , n : usize) -> crate :: common :: Reg < regs :: Dor , crate :: common :: R > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x2cusize + n * 4usize) as _) } } } pub mod regs { # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn tsel (& self , n : usize) -> super :: vals :: TrigSel { assert ! (n < 2usize) ; let offs = 3usize + n * 16usize ; let val = (self . 0 >> offs) & 0x07 ; super :: vals :: TrigSel :: from_bits (val as u8) } # [doc = "channel trigger selection"]
# [inline (always)]
pub fn set_tsel (& mut self , n : usize , val : super :: vals :: TrigSel) { assert ! (n < 2usize) ; let offs = 3usize + n * 16usize ; self . 0 = (self . 0 & ! (0x07 << offs)) | (((val . to_bits () as u32) & 0x07) << offs) ; } # [doc = "channel noise/triangle wave generation enable"]
# [inline (always)]
...
# [inline (always)]
pub fn set_dmaen (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 12usize + n * 16usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Cr { # [inline (always)]
...
fn default () -> Dor { Dor (0) } } # [doc = "software trigger register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Swtrigr { Swtrigr (0) } } } pub mod vals { # [doc = "DAC channel1/2 trigger selection."]
# [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum TrigSel { # [doc = "TIM6 TRGO event."]
TIM6_TRGO = 0x0 , # [doc = "TIM8 TRGO event."]
TIM8_TRGO = 0x01 , # [doc = "TIM7 TRGO event."]
TIM7_TRGO = 0x02 , # [doc = "TIM5 TRGO event."]
TIM5_TRGO = 0x03 , # [doc = "TIM2 TRGO event."]
TIM2_TRGO = 0x04 , # [doc = "TIM4 TRGO event."]
TIM4_TRGO = 0x05 , # [doc = "External line 9."]
EXTI9 = 0x06 , # [doc = "Software trigger."]
SOFTWARE = 0x07 , } impl TrigSel { # [inline (always)]
pub const fn from_bits (val : u8) -> TrigSel { unsafe { core :: mem :: transmute (val & 0x07) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for TrigSel { # [inline (always)]
fn from (val : u8) -> TrigSel { TrigSel :: from_bits (val) } } impl From < TrigSel > for u8 { # [inline (always)]
fn from (val : TrigSel) -> u8 { TrigSel :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
