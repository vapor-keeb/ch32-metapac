...
# [inline (always)]
pub const fn ch (self , n : usize) -> Ch { assert ! (n < 8usize) ; unsafe { Ch :: from_ptr (self . ptr . add (0x08usize + n * 20usize) as _) } } # [doc = "Channel cluster: CCR?, CNDTR?, CPAR?, and CMAR? registers"]
# [inline (always)]
pub const fn ech (self , n : usize) -> Ch { assert ! (n < 3usize) ; unsafe { Ch :: from_ptr (self . ptr . add (0xa0usize + n * 20usize) as _) } } # [doc = "DMA interrupt status register (DMA_ISR)"]
# [inline (always)]
pub const fn eisr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0xd0usize) as _) } } # [doc = "DMA interrupt flag clear register (DMA_IFCR)"]
# [inline (always)]
pub const fn eifcr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0xd4usize) as _) } } } pub mod regs { # [doc = "DMA channel configuration register (DMA_CCR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
