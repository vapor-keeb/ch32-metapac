...
# [inline (always)]
pub fn set_usbhsrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } } impl Default for Ahbrstr { # [inline (always)]
...
# [inline (always)]
pub const fn usbpre (& self) -> bool { let val = (self . 0 >> 22usize) & 0x01 ; val != 0 } # [doc = "USB prescaler."]
# [inline (always)]
pub fn set_usbpre (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize) ; } # [doc = "Microcontroller clock output."]
# [inline (always)]
...
PLL = 0x02 , # [doc = "Reserved."]
RESERVED = 0x03 , } impl Sw { # [inline (always)]
