...
pub mod regs {
    ...
    impl Ahbpcenr {
        ...
        #[doc = "USBHD clock enable."]
        #[inline(always)]
        pub const fn usbhden(&self) -> bool {
            let val = (self.0 >> 12usize) & 0x01;
            val != 0
        }
        #[doc = "USBHD clock enable."]
        #[inline(always)]
        pub fn set_usbhden(&mut self, val: bool) {
    ...
    impl Cfgr0 {
        ...
        #[doc = "Microcontroller clock output."]
        #[inline(always)]
        pub fn set_mco(&mut self, val: u8) {
...
pub mod vals {
    ...
    #[doc = "PLLMUL configuration. max 72MHz"]
    #[repr(u8)]
    #[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
    pub enum PllMul {
