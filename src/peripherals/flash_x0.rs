...
impl Flash {
    ...
    #[doc = "BOOT Mode select register."]
    #[inline(always)]
    pub const fn boot_modekeyp(self) -> crate::common::Reg<regs::BootModekeyp, crate::common::W> {
...
pub mod regs {
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct BootModekeyp(pub u32);
    impl BootModekeyp {
        #[doc = "Mode select."]
        #[inline(always)]
    ...
    impl Default for BootModekeyp {
        #[inline(always)]
        fn default() -> BootModekeyp {
            BootModekeyp(0)
        }
    }
    #[doc = "Control register."]
    ...
    impl Obr {
        ...
        #[doc = "Config reset delay time."]
        #[inline(always)]
        pub const fn cfgrstt(&self) -> u8 {
            let val = (self.0 >> 5usize) & 0x03;
            val as u8
        }
        #[doc = "Config reset delay time."]
        #[inline(always)]
        pub fn set_cfgrstt(&mut self, val: u8) {
    ...
    impl Statr {
        ...
        #[doc = "BOOT_AVA."]
        #[inline(always)]
        pub const fn boot_ava(&self) -> bool {
            let val = (self.0 >> 12usize) & 0x01;
            val != 0
        }
        #[doc = "BOOT_AVA."]
        #[inline(always)]
        pub fn set_boot_ava(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        #[doc = "BOOT_STATUS."]
        #[inline(always)]
        ...
        #[doc = "BOOT_STATUS."]
        #[inline(always)]
        pub fn set_boot_status(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        #[doc = "BOOT_MODE."]
        #[inline(always)]
